...
public class Hazard : MonoBehaviour
{
    ...
    public SpriteRenderer nearIdol;
    public SpriteRenderer idol;
    public bool hasIdol = false;
    public UnityEvent RollingStone;
    ...
    void Update()
    {
        ...
        if (Keyboard.current != null && nearIdol.bounds.Contains(transform.position) && Keyboard.current.spaceKey.wasPressedThisFrame)
        {
            Destroy(idol);
            hasIdol = true;
            RollingStone.Invoke();
